...
int main(const int argc, const char ** const argv)
{
    ...
    return 0;
}/* <stdin>:13:9: warning: 'M_PI' macro redefined [-Wmacro-redefined]
#define M_PI 3.14159265358979323846264338327
        ^
/Users/javier/Documents/Develop/emsdk/fastcomp/emscripten/system/include/libc/math.h:363:9: note: previous definition is here
