(module
  ...
  (import "env" "___syscall140" (func (;5;) (type 5)))
  (import "env" "___syscall146" (func (;6;) (type 5)))
  (import "env" "___syscall54" (func (;7;) (type 5)))
  (import "env" "___syscall6" (func (;8;) (type 5)))
  (import "env" "_emscripten_asm_const_i" (func (;9;) (type 2)))
  (import "env" "_emscripten_cancel_main_loop" (func (;10;) (type 1)))
  (import "env" "_emscripten_get_now" (func (;11;) (type 6)))
  (import "env" "_emscripten_memcpy_big" (func (;12;) (type 0)))
  (import "env" "_emscripten_set_main_loop" (func (;13;) (type 7)))
  (import "env" "_emscripten_set_main_loop_timing" (func (;14;) (type 5)))
  (import "env" "_exit" (func (;15;) (type 3)))
  ...
  (func (;17;) (type 11) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get 4
    local.set 5
    global.get 4
  ...
  (func (;22;) (type 10) (param i64 i32) (result i32)
    (local i32 i32 i64)
    local.get 0
    i32.wrap_i64
    local.set 2
  ...
  (func (;27;) (type 8) (param i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 12)
  (func (;28;) (type 1)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f32 f64 f64)
    global.get 4
    local.set 5
    global.get 4
    i32.const 32
  ...
  (func (;43;) (type 5) (param i32 i32) (result i32)
    ...
    global.set 4
    local.get 1)
  (func (;44;) (type 14) (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 2
    local.get 1
    i32.mul
  ...
  (export "_main" (func 36))
  (export "dynCall_v" (func 40))
  (export "stackAlloc" (func 58))
  (elem (;0;) (global.get 0) 39 57 38 55 56 34 37 28)
  (data (;0;) (i32.const 1024) "\04\04\00\00\05")
  (data (;1;) (i32.const 1040) "\01")
  (data (;2;) (i32.const 1064) "\01\00\00\00\02\00\00\00(\14\00\00\00\04")
  (data (;3;) (i32.const 1088) "\01")
  (data (;4;) (i32.const 1103) "\0a\ff\ff\ff\ff")
  (data (;5;) (i32.const 1341) "\14")
  (data (;6;) (i32.const 1396) "Ran %d matrix multiplications (across %d frames). Total elapsed: %f seconds. Checksum: %f.\0a\00Not enough parameters specified. Running with defaults: A=%d B=%d C=%d NumFrames=%d ItersPerFrame=%d Method=%d.\0a\00return ENVIRONMENT_IS_WEB\00Performing %d multiplications of matrices of size %dx%d and %dx%d. Distributing multiplication across %d animation frames (matrix muls per frame=%d).\0a\00Invalid frame scheduling method %d specifiec!\0a\00Using setImmediate/postMessage() to schedule frames.\00Using requestAnimationFrame() to schedule frames.\00Using setTimeout(0) to schedule frames.\00Usage: matrix_multiply A B C NumFrames ItersPerFrame Method\00Method is one of: 0=setTimeout, 1=requestAnimationFrame, 2=setImmediate\00\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b")
  (data (;7;) (i32.const 2132) "\11\00\0f\0a\11\11\11\03\0a\07\00\01\13\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
  (data (;8;) (i32.const 2181) "\0b")
  (data (;9;) (i32.const 2190) "\11\00\0a\0a\11\11\11\00\0a\00\00\02\00\09\0b\00\00\00\09\00\0b\00\00\0b")
  (data (;10;) (i32.const 2239) "\0c")
  (data (;11;) (i32.const 2251) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data (;12;) (i32.const 2297) "\0e")
  (data (;13;) (i32.const 2309) "\0d\00\00\00\04\0d\00\00\00\00\09\0e\00\00\00\00\00\0e\00\00\0e")
  (data (;14;) (i32.const 2355) "\10")
  (data (;15;) (i32.const 2367) "\0f\00\00\00\00\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10\00\00\12\00\00\00\12\12\12")
  (data (;16;) (i32.const 2422) "\12\00\00\00\12\12\12\00\00\00\00\00\00\09")
  (data (;17;) (i32.const 2471) "\0b")
  (data (;18;) (i32.const 2483) "\0a\00\00\00\00\0a\00\00\00\00\09\0b\00\00\00\00\00\0b\00\00\0b")
  (data (;19;) (i32.const 2529) "\0c")
  (data (;20;) (i32.const 2541) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c\00\00-+   0X0x\00(null)\00-0X+0X 0X-0x+0x 0x\00inf\00INF\00nan\00NAN\000123456789ABCDEF.\00T!\22\19\0d\01\02\03\11K\1c\0c\10\04\0b\1d\12\1e'hnopqb \05\06\0f\13\14\15\1a\08\16\07($\17\18\09\0a\0e\1b\1f%#\83\82}&*+<=>?CGJMXYZ[\5c]^_`acdefgijklrstyz{|\00Illegal byte sequence\00Domain error\00Result not representable\00Not a tty\00Permission denied\00Operation not permitted\00No such file or directory\00No such process\00File exists\00Value too large for data type\00No space left on device\00Out of memory\00Resource busy\00Interrupted system call\00Resource temporarily unavailable\00Invalid seek\00Cross-device link\00Read-only file system\00Directory not empty\00Connection reset by peer\00Operation timed out\00Connection refused\00Host is down\00Host is unreachable\00Address in use\00Broken pipe\00I/O error\00No such device or address\00Block device required\00No such device\00Not a directory\00Is a directory\00Text file busy\00Exec format error\00Invalid argument\00Argument list too long\00Symbolic link loop\00Filename too long\00Too many open files in system\00No file descriptors available\00Bad file descriptor\00No child process\00Bad address\00File too large\00Too many links\00No locks available\00Resource deadlock would occur\00State not recoverable\00Previous owner died\00Operation canceled\00Function not implemented\00No message of desired type\00Identifier removed\00Device not a stream\00No data available\00Device timeout\00Out of streams resources\00Link has been severed\00Protocol error\00Bad message\00File descriptor in bad state\00Not a socket\00Destination address required\00Message too large\00Protocol wrong type for socket\00Protocol not available\00Protocol not supported\00Socket type not supported\00Not supported\00Protocol family not supported\00Address family not supported by protocol\00Address not available\00Network is down\00Network unreachable\00Connection reset by network\00Connection aborted\00No buffer space available\00Socket is connected\00Socket not connected\00Cannot send after socket shutdown\00Operation already in progress\00Operation in progress\00Stale file handle\00Remote I/O error\00Quota exceeded\00No medium found\00Wrong medium type\00No error information"))
