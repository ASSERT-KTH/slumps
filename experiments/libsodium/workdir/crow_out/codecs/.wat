(module
  ...
  (func $strchr (type 3) (param i32 i32) (result i32)
    ...
    i32.eq
    select)
  (func $sodium_bin2hex (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block  ;; label = @1
      local.get 3
      i32.const 2147483647
    ...
    call $sodium_misuse
    unreachable)
  (func $sodium_hex2bin (type 16) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 7)
  (func $sodium_base64_encoded_len (type 3) (param i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 1
      i32.const -7
    ...
    i32.mul
    i32.add)
  (func $sodium_bin2base64 (type 13) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
    ...
    drop
    local.get 0)
  (func $sodium_base642bin (type 17) (param i32 i32 i32 i32 i32 i32 i32 i32) (result i32)
  ...
  (export "sodium_bin2hex" (func $sodium_bin2hex))
  (export "sodium_hex2bin" (func $sodium_hex2bin))
  (export "sodium_base64_encoded_len" (func $sodium_base64_encoded_len))
  (export "sodium_bin2base64" (func $sodium_bin2base64))
  (export "sodium_base642bin" (func $sodium_base642bin))
