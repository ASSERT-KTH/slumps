(module
  ...
  (import "env" "crypto_auth_hmacsha512_init" (func $crypto_auth_hmacsha512_init (type 0)))
  (import "env" "crypto_auth_hmacsha512_update" (func $crypto_auth_hmacsha512_update (type 8)))
  (import "env" "crypto_auth_hmacsha512_final" (func $crypto_auth_hmacsha512_final (type 3)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $crypto_auth_hmacsha512256_bytes (type 12) (result i32)
    i32.const 32)
  (func $crypto_auth_hmacsha512256_keybytes (type 12) (result i32)
    i32.const 32)
  (func $crypto_auth_hmacsha512256_statebytes (type 12) (result i32)
    i32.const 416)
  (func $crypto_auth_hmacsha512256_keygen (type 2) (param i32)
    local.get 0
    i32.const 32
    call $randombytes_buf)
  (func $crypto_auth_hmacsha512256_init (type 0) (param i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    call $crypto_auth_hmacsha512_init)
  (func $crypto_auth_hmacsha512256_update (type 8) (param i32 i32 i64) (result i32)
    local.get 0
    local.get 1
    local.get 2
    call $crypto_auth_hmacsha512_update)
  (func $crypto_auth_hmacsha512256_final (type 3) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 64
    i32.sub
    ...
    local.get 0
    local.get 2
    call $crypto_auth_hmacsha512_final
    drop
    local.get 1
    i32.const 24
    i32.add
    ...
    global.set 0
    i32.const 0)
  (func $crypto_auth_hmacsha512256 (type 17) (param i32 i32 i64 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 480
    i32.sub
    ...
    global.set 0
    i32.const 0)
  (func $crypto_auth_hmacsha512256_verify (type 17) (param i32 i32 i64 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 512
    i32.sub
  ...
  (export "crypto_auth_hmacsha512256_bytes" (func $crypto_auth_hmacsha512256_bytes))
  (export "crypto_auth_hmacsha512256_keybytes" (func $crypto_auth_hmacsha512256_keybytes))
  (export "crypto_auth_hmacsha512256_statebytes" (func $crypto_auth_hmacsha512256_statebytes))
  (export "crypto_auth_hmacsha512256_keygen" (func $crypto_auth_hmacsha512256_keygen))
  (export "crypto_auth_hmacsha512256_init" (func $crypto_auth_hmacsha512256_init))
  (export "crypto_auth_hmacsha512256_update" (func $crypto_auth_hmacsha512256_update))
  (export "crypto_auth_hmacsha512256_final" (func $crypto_auth_hmacsha512256_final))
  (export "crypto_auth_hmacsha512256" (func $crypto_auth_hmacsha512256))
  (export "crypto_auth_hmacsha512256_verify" (func $crypto_auth_hmacsha512256_verify))
