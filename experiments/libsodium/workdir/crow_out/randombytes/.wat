(module
  ...
  (import "wasi_snapshot_preview1" "args_sizes_get" (func $__wasi_args_sizes_get (type 7)))
  (import "wasi_snapshot_preview1" "args_get" (func $__wasi_args_get (type 7)))
  (import "env" "main" (func $main (type 7)))
  ...
  (import "wasi_snapshot_preview1" "fd_fdstat_get" (func $__wasi_fd_fdstat_get (type 7)))
  (import "wasi_snapshot_preview1" "fd_write" (func $__wasi_fd_write (type 9)))
  (import "env" "crypto_stream_chacha20_ietf" (func $crypto_stream_chacha20_ietf (type 8)))
  (func $__wasm_call_ctors (type 3))
  (func $polybench_flush_cache (type 3)
    ...
    global.set 0
    return)
  (func $polybench_prepare_instruments (type 3)
    call $polybench_flush_cache
    return)
  (func $polybench_timer_start (type 3)
    (local f64 i32)
  ...
  (func $rtclock (type 10) (result f64)
    ...
    local.get 1
    return)
  (func $polybench_timer_stop (type 3)
    (local f64 i32)
    call $rtclock
    local.set 0
    i32.const 0
    ...
    return)
  (func $polybench_timer_print (type 3)
    ...
    global.set 0
    return)
  (func $polybench_free_data (type 6) (param i32)
  ...
  (func $sbrk (type 4) (param i32) (result i32)
    ...
    call $abort
    unreachable)
  (func $main.1 (type 7) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $main)
  ...
  (func $__strerror_l (type 7) (param i32 i32) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 2
    block  ;; label = @1
  ...
  (func $long_double_not_supported (type 3)
    i32.const 3312
    i32.const 3592
    call $fputs
    drop
  ...
  (func $__towrite (type 4) (param i32) (result i32)
    ...
    i32.store offset=16
    i32.const 0)
  (func $__towrite_needs_stdio_exit (type 3)
    call $__stdio_exit)
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $randombytes_set_implementation (type 4) (param i32) (result i32)
    i32.const 0
    local.get 0
    i32.store offset=5480
    i32.const 0)
  (func $randombytes_implementation_name (type 2) (result i32)
    call $randombytes_init_if_needed
    i32.const 0
    i32.load offset=5480
    i32.load
    call_indirect (type 2))
  (func $randombytes_init_if_needed (type 3)
    (local i32)
    block  ;; label = @1
      i32.const 0
      i32.load offset=5480
  ...
  (func $randombytes_random (type 2) (result i32)
    call $randombytes_init_if_needed
    i32.const 0
    i32.load offset=5480
    i32.load offset=4
    call_indirect (type 2))
  (func $randombytes_stir (type 3)
    (local i32)
    call $randombytes_init_if_needed
    block  ;; label = @1
      i32.const 0
  ...
  (func $randombytes_uniform (type 4) (param i32) (result i32)
    (local i32 i32)
    call $randombytes_init_if_needed
    i32.const 0
    local.set 1
    ...
    local.get 1)
  (func $randombytes_buf (type 5) (param i32 i32)
    call $randombytes_init_if_needed
    block  ;; label = @1
      local.get 1
      i32.eqz
  ...
  (func $randombytes_buf_deterministic (type 14) (param i32 i32 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i32.const 3520
    ...
    drop)
  (func $randombytes_seedbytes (type 2) (result i32)
    i32.const 32)
  (func $randombytes_close (type 2) (result i32)
    (local i32 i32)
    i32.const 0
    local.set 0
    block  ;; label = @1
    ...
    local.get 0)
  (func $randombytes (type 16) (param i32 i64)
    (local i32)
    block  ;; label = @1
      local.get 1
      i64.const 4294967296
  ...
  (export "randombytes_set_implementation" (func $randombytes_set_implementation))
  (export "randombytes_implementation_name" (func $randombytes_implementation_name))
  (export "randombytes_random" (func $randombytes_random))
  (export "randombytes_stir" (func $randombytes_stir))
  (export "randombytes_uniform" (func $randombytes_uniform))
  (export "randombytes_buf" (func $randombytes_buf))
  (export "randombytes_buf_deterministic" (func $randombytes_buf_deterministic))
  (export "randombytes_seedbytes" (func $randombytes_seedbytes))
  (export "randombytes_close" (func $randombytes_close))
  (export "randombytes" (func $randombytes))
