(module
  ...
  (import "env" "blake2b_long" (func $blake2b_long (type 6)))
  (import "env" "sodium_memzero" (func $sodium_memzero (type 7)))
  (import "env" "argon2_fill_segment_ref" (func $argon2_fill_segment_ref (type 7)))
  (import "env" "crypto_generichash_blake2b_init" (func $crypto_generichash_blake2b_init (type 6)))
  (import "env" "crypto_generichash_blake2b_update" (func $crypto_generichash_blake2b_update (type 8)))
  (import "env" "crypto_generichash_blake2b_final" (func $crypto_generichash_blake2b_final (type 0)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $argon2_finalize (type 7) (param i32 i32)
    ...
    block  ;; label = @1
      ...
      local.get 0
      i32.load offset=56
      call $argon2_free_instance
    end
    local.get 2
    i32.const 2048
    i32.add
    global.set 0)
  (func $argon2_free_instance (type 7) (param i32 i32)
    (local i32)
    block  ;; label = @1
      local.get 1
      i32.const 4
    ...
    i32.const 0
    i32.store)
  (func $argon2_fill_memory_blocks (type 7) (param i32 i32)
    (local i32 i32)
    global.get 0
    i32.const 80
    i32.sub
    ...
    i32.add
    global.set 0)
  (func $argon2_validate_inputs (type 5) (param i32) (result i32)
    (local i32 i32 i32)
    block  ;; label = @1
      local.get 0
      i32.eqz
    ...
    i32.and
    select)
  (func $argon2_initialize (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    global.get 0
    local.tee 2
    local.set 3
    ...
    block  ;; label = @1
      ...
      i32.const 0
      i32.const 64
      call $crypto_generichash_blake2b_init
      drop
      local.get 2
      local.get 1
      i32.load offset=48
      ...
      i32.add
      i64.const 4
      call $crypto_generichash_blake2b_update
      drop
      local.get 2
      local.get 1
      i32.load offset=4
      ...
      i32.add
      i32.const 64
      call $crypto_generichash_blake2b_final
      drop
      local.get 2
      i32.const 48
      i32.add
    ...
    global.set 0
    local.get 4)
  (func $_crypto_pwhash_argon2_pick_best_implementation (type 12) (result i32)
    i32.const 0)
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  ...
  (export "argon2_finalize" (func $argon2_finalize))
  (export "argon2_fill_memory_blocks" (func $argon2_fill_memory_blocks))
  (export "argon2_validate_inputs" (func $argon2_validate_inputs))
  (export "argon2_initialize" (func $argon2_initialize))
  (export "_crypto_pwhash_argon2_pick_best_implementation" (func $_crypto_pwhash_argon2_pick_best_implementation))
