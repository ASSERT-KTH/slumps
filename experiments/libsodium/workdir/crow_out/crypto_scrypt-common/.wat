(module
  ...
  (type (;7;) (func (param i32 i32 i32 i32 i32 i64 i32 i32 i32 i32) (result i32)))
  ...
  (type (;19;) (func (param i32 i32 i32 i32 i64 i32 i32 i32 i32) (result i32)))
  ...
  (import "env" "escrypt_kdf_nosse" (func $escrypt_kdf_nosse (type 7)))
  ...
  (func $__memrchr (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 4
    i32.add)
  (func $strrchr (type 3) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 0
    call $strlen
    ...
    i32.add
    call $__memrchr)
  (func $escrypt_parse_setting (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    i32.const 0
    local.set 4
    block  ;; label = @1
    ...
    local.get 4)
  (func $decode64_uint32 (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    block  ;; label = @1
      i32.const 3520
      local.get 1
    ...
    i32.store
    i32.const 0)
  (func $escrypt_r (type 17) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    global.get 0
    i32.const 48
    i32.sub
    ...
    global.set 0
    local.get 7)
  (func $escrypt_gensalt_r (type 18) (param i32 i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    local.get 4
    i32.const 3
    i32.shl
    ...
    local.get 8)
  (func $crypto_pwhash_scryptsalsa208sha256_ll (type 19) (param i32 i32 i32 i32 i64 i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (export "escrypt_parse_setting" (func $escrypt_parse_setting))
  (export "escrypt_r" (func $escrypt_r))
  (export "escrypt_gensalt_r" (func $escrypt_gensalt_r))
  (export "crypto_pwhash_scryptsalsa208sha256_ll" (func $crypto_pwhash_scryptsalsa208sha256_ll))
