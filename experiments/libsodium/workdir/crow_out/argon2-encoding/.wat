(module
  ...
  (import "env" "sodium_base642bin" (func $sodium_base642bin (type 7)))
  (import "env" "argon2_validate_inputs" (func $argon2_validate_inputs (type 5)))
  (import "env" "sodium_bin2base64" (func $sodium_bin2base64 (type 8)))
  ...
  (func $strncmp (type 0) (param i32 i32 i32) (result i32)
    ...
    i32.load8_u
    i32.sub)
  (func $argon2_decode_string (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 6)
  (func $argon2_encode_string (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    global.get 0
    i32.const 32
    i32.sub
      ...
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
            ...
            i32.add
            i32.const 0
            i64.load offset=3560 align=1
            i64.store align=1
            local.get 0
            i32.const 0
            i64.load offset=3555 align=1
            i64.store align=1
            i32.const -12
            local.set 3
            i32.const 12
          ...
          i32.add
          i32.const 0
          i32.load offset=3576 align=1
          i32.store align=1
          local.get 0
          i32.const 0
          i64.load offset=3568 align=1
          i64.store align=1
          i32.const -11
          local.set 3
          i32.const 11
  ...
  (export "argon2_decode_string" (func $argon2_decode_string))
  (export "argon2_encode_string" (func $argon2_encode_string))
