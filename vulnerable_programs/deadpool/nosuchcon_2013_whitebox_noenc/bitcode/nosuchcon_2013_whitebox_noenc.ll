; ModuleID = 'nosuchcon_2013_whitebox_noenc.bc'
...
lor.rhs:                                          ; preds = %entry
  ...
  %2 = select i1 %cmp13, i1 %cmp16, i1 false
  %phitmp = zext i1 %2 to i8
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %entry
  %3 = phi i8 [ %phitmp, %lor.rhs ], [ 1, %entry ]
  ret i8 %3
}
...
is_hex_char.exit:                                 ; preds = %for.body
  ...
  %8 = select i1 %cmp13.i, i1 %cmp16.i, i1 false
  br i1 %8, label %lor.lhs.false, label %cleanup

lor.lhs.false:                                    ; preds = %is_hex_char.exit, %for.body
  %9 = or i64 %indvars.iv317, 1
  %arrayidx9 = getelementptr inbounds i8, i8* %4, i64 %9
  %10 = load i8, i8* %arrayidx9, align 1, !tbaa !6
  %c.off.i279 = add i8 %10, -48
  %11 = icmp ult i8 %c.off.i279, 10
  %c.off25.i280 = add i8 %10, -97
  %12 = icmp ult i8 %c.off25.i280, 6
  %or.cond.i281 = or i1 %11, %12
  br i1 %or.cond.i281, label %if.end, label %is_hex_char.exit286

is_hex_char.exit286:                              ; preds = %lor.lhs.false
  %cmp13.i282 = icmp sgt i8 %10, 64
  %cmp16.i283 = icmp slt i8 %10, 71
  %13 = select i1 %cmp13.i282, i1 %cmp16.i283, i1 false
  br i1 %13, label %if.end, label %cleanup
...
if.end:                                           ; preds = %is_hex_char.exit286, %lor.lhs.false
  ...
  store i8 %10, i8* %arrayinit.element, align 1, !tbaa !6
  ...
  %14 = lshr exact i64 %indvars.iv317, 1
  %arrayidx27 = getelementptr inbounds [16 x i8], [16 x i8]* %m, i64 0, i64 %14
...
for.end:                                          ; preds = %if.end
  ...
  %15 = call i64 @fread_unlocked(i8* nonnull %0, i64 1, i64 349184, %struct._IO_FILE* %call31)
  ...
  %16 = load i8, i8* %2, align 16, !tbaa !6
  ...
  %17 = load i8, i8* %arrayidx41.1, align 1, !tbaa !6
  %conv42.1 = zext i8 %17 to i32
  ...
  %18 = load i8, i8* %arrayidx41.2, align 2, !tbaa !6
  %conv42.2 = zext i8 %18 to i32
  ...
  %19 = load i8, i8* %arrayidx41.3, align 1, !tbaa !6
  %conv42.3 = zext i8 %19 to i32
  ...
  %20 = load i8, i8* %arrayidx41.4, align 4, !tbaa !6
  %conv42.4 = zext i8 %20 to i32
  ...
  %21 = load i8, i8* %arrayidx41.5, align 1, !tbaa !6
  %conv42.5 = zext i8 %21 to i32
  ...
  %22 = load i8, i8* %arrayidx41.6, align 2, !tbaa !6
  %conv42.6 = zext i8 %22 to i32
  ...
  %23 = load i8, i8* %arrayidx41.7, align 1, !tbaa !6
  %conv42.7 = zext i8 %23 to i32
  ...
  %24 = load i8, i8* %arrayidx41.8, align 8, !tbaa !6
  %conv42.8 = zext i8 %24 to i32
  ...
  %25 = load i8, i8* %arrayidx41.9, align 1, !tbaa !6
  %conv42.9 = zext i8 %25 to i32
  ...
  %26 = load i8, i8* %arrayidx41.10, align 2, !tbaa !6
  %conv42.10 = zext i8 %26 to i32
  ...
  %27 = load i8, i8* %arrayidx41.11, align 1, !tbaa !6
  %conv42.11 = zext i8 %27 to i32
  ...
  %28 = load i8, i8* %arrayidx41.12, align 4, !tbaa !6
  %conv42.12 = zext i8 %28 to i32
  ...
  %29 = load i8, i8* %arrayidx41.13, align 1, !tbaa !6
  %conv42.13 = zext i8 %29 to i32
  ...
  %30 = load i8, i8* %arrayidx41.14, align 2, !tbaa !6
  %conv42.14 = zext i8 %30 to i32
  ...
  %31 = load i8, i8* %arrayidx41.15, align 1, !tbaa !6
  %conv42.15 = zext i8 %31 to i32
...
for.body90:                                       ; preds = %for.body90, %for.cond86.preheader
  ...
  %conv87296 = phi i32 [ 0, %for.cond86.preheader ], [ %59, %for.body90 ]
  ...
  %48 = load i8, i8* %arrayidx115, align 1, !tbaa !6
  %idxprom116 = zext i8 %48 to i64
  ...
  %49 = load i8, i8* %arrayidx117, align 1, !tbaa !6
  ...
  %50 = load i8, i8* %arrayidx115.1, align 1, !tbaa !6
  %idxprom116.1 = zext i8 %50 to i64
  ...
  %51 = load i8, i8* %arrayidx117.1, align 1, !tbaa !6
  ...
  %52 = load i8, i8* %arrayidx115.2, align 1, !tbaa !6
  %idxprom116.2 = zext i8 %52 to i64
  ...
  %53 = load i8, i8* %arrayidx117.2, align 1, !tbaa !6
  ...
  %54 = load i8, i8* %arrayidx115.3, align 1, !tbaa !6
  %idxprom116.3 = zext i8 %54 to i64
  ...
  %57 = load i8, i8* %arrayidx143, align 1, !tbaa !6
  %conv144 = zext i8 %57 to i64
