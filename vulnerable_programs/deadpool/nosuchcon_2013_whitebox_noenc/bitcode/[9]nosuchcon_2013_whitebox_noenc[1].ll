; ModuleID = '[9]nosuchcon_2013_whitebox_noenc[1].bc'
...
lor.rhs:                                          ; preds = %entry
  ...
  %6 = icmp ult i8 %5, 6
  %7 = zext i1 %6 to i8
  %phitmp = zext i1 %4 to i8
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %entry
  %8 = phi i8 [ %7, %lor.rhs ], [ 1, %entry ]
  ret i8 %8
}
...
is_hex_char.exit:                                 ; preds = %for.body
  ...
  br i1 %10, label %lor.lhs.false, label %cleanup
...
is_hex_char.exit286:                              ; preds = %lor.lhs.false
  ...
  br i1 %17, label %if.end, label %cleanup
